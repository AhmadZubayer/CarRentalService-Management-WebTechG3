...
function loadOrders() {
    ...
    var params = 'module=order&action=getOrders&status=' + encodeURIComponent(status) + '&date=' + encodeURIComponent(date);
...
function updateOrderStatus(id, status) {
    ...
    xhr.send('module=order&action=updateStatus&id=' + id + '&status=' + encodeURIComponent(status));
}
